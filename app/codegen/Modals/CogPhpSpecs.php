...
EOD;
    ...
    public function genFkbColMethodBodyDetail(FiKeybean $fkbItem): FiStrbui
  {
    ...
    if ($ofcTxFieldName != null)
      $sbFiColMethodBody->append(sprintf("  \$fkbCol->addFiCol(FicFiCol::ofcTxFieldName(), '%s');\n", $ofcTxFieldName));

    $ofcTxHeader = $fkbItem->getValueByFiCol(FicFiCol::ofcTxHeader());
    if ($ofcTxHeader != null)
      $sbFiColMethodBody->append(sprintf("  \$fkbCol->addFiCol(FicFiCol::ofcTxHeader(), '%s');\n", $ofcTxHeader));

    $ofcTxFieldType = $fkbItem->getValueByFiCol(FicFiCol::ofcTxFieldType());
    if ($ofcTxFieldType != null)
      $sbFiColMethodBody->append(sprintf("  \$fkbCol->addFiCol(FicFiCol::ofcTxFieldType(), '%s');\n", $ofcTxFieldType));
