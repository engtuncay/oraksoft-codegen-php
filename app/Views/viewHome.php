              ...
              <form action="#" method="post" enctype="multipart/form-data">
                ...
                <div id="divSelBoxs" class="">
                  <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-3">
                    ...
                    <div class="mb-3">
                      <label for="selSqlite" class="block text-sm font-medium mb-2">Sqlite</label>
                      <select class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" aria-label="Sqlite Operations" name="selSqlite" id="selSqlite">
                      </select>
                    </div>
