...
class CogPhpFkbCol implements ICogGenClassCode
{
...
EOD;
   ...
   * @return void
   */
  public function doNonTransientFieldOps(FiStrbui $sbFclListBody, Fkb $fkbItem, ICogSpecs $iCogSpecs): void //, string $methodName
  {
