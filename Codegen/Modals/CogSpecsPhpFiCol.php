...
EOD;
  ...
  //   //    $fkbCol->addFiCol(FicFiCol::fcTxFieldName(),'evsTxMustKod'); // "ofcTxFieldType", 'string'); //->fcTxFieldType = 'string';
  //   // $fkbCol->addFiCol(FicFiCol::fcTxFieldType(), 'string'); //->fcTxFieldType = 'string';

  //   $ofcTxFieldName = $fkbItem->getValueByFiCol(FicFiCol::fcTxFieldName());
